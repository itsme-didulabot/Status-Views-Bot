...
const { default: makeWASocket, getAggregateVotesInPollMessage, useMultiFileAuthState, DisconnectReason, getDevice, fetchLatestBaileysVersion, jidNormalizedUser, getContentType, Browsers, makeInMemoryStore, makeCacheableSignalKeyStore, downloadContentFromMessage, generateWAMessageFromContent, prepareWAMessageMedia, generateForwardMessageContent, proto } = require("@whiskeysockets/baileys");
...
async function connectToWA() {
  ...
  conn.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      conn.sendMessage(ownerNumber[0] + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/tC37Q7B/20241220-122443.jpg` }, caption: up });
    }
  });
